...
# Creates the neural network for the models
def makeBrain():
    brain = Sequential()
...
def createInitialPopulation():
    ...
    print("Media {}".format(np.average(scores)))
    best_models = getBestModels(models_list, scores)
    saveBestModels(best_models)

# Creates a new population using the previous best models
def breedModels():
    models = []
...
# Runs the population on the game
...
# Selects the N best models based on their scores
...
# Rewards the model based on performance
